...
ILI9341TFT320480 = ili9341_ns.class_("ILI9341TFT320480", ili9341)
...
MODELS = {
    ...
    "TFT_320x480": ILI9341Model.TFT_320_480,
}
...
async def to_code(config):
    ...
    if config[CONF_MODEL] == "TFT_320x480":
        lcd_type = ILI9341TFT320480
    rhs = lcd_type.new()
